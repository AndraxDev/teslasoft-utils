...
# To run command please go to http://<SERVER_NAME>:36905/data/controller.py?command=<YOUR_COMMAND>&<ADDITIONAL_ARGUMENTS_HERE> in your web browser
#
# List of commands
...
#    shell <DATA> - run command line command ("%20" will be replaced with a space (" "))
#    color <COLOR> - change led color
#    controller <SIGNAL> - send signals from joystick
